...
def predict():
    ...
    if output == 0:
        return render_template('Prediction2.html', prediction_text= 'You are not suffering from Kidney Disese')
    else:
        return render_template('PositivePred.html', prediction_text= 'Ouch! You are suffering from Kidney Disease')
...
def predict1():
    ...
    if output == 1:
        return render_template('PositivePred2.html', prediction_text= 'You are suffering from liver Disese')
    else:
...
def predict2():
    ...
    if output == 0:
        return render_template('Positiveh.html', prediction_text= 'You are suffering from Heart Disese')
    else:
...
@app.route('/PositivePred')
def PositivePred():
    return render_template('PositivePred.html')

@app.route('/PositivePred2')
def PositivePred2():
    return render_template('PositivePred2.html')

@app.route('/Positiveh')
def Positiveh():
    return render_template('Positiveh.html')
